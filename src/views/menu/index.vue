  ...
  <div class="app-container">
    <el-form :inline="true">
      ...
      <el-form-item>
        ...
        <el-button
          v-permisaction="['permission:sysmenu:add']"
          type="primary"
          icon="el-icon-plus"
          size="mini"
          @click="handleAdd"
    ...
    >
      ...
      <el-table-column v-if="checkPermission(['admin', 'editor'])" label="操作" align="center" class-name="small-padding fixed-width" width="230">
        <template slot-scope="scope">
          <el-button
            v-permisaction="['permission:sysmenu:edit']"
            size="mini"
            type="text"
            icon="el-icon-edit"
          ...
          >新增</el-button>
          <el-button
            v-permisaction="['permission:sysmenu:remove']"
            size="mini"
            type="text"
            icon="el-icon-delete"
    ...
    <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="open" width="600px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item v-if="form.menuType == 'M' || form.menuType == 'C'" label="菜单图标">
              <el-popover
...
export default {
  ...
  data() {
    return {
      ...
      open: false,
      // 菜单状态数据字典
      visibleOptions: [{ 'dictValue': '1', 'dictLabel': '显示' }, { 'dictValue': '0', 'dictLabel': '隐藏' }],
      // 查询参数
      queryParams: {
        title: undefined,
        visible: undefined
